...
function DropdownAdmin({ getMembers, memberId }: { getMembers: () => Promise<void>, memberId : string }) {
          ...
          <Menu.Items className="z-50 origin-top-right absolute right-0 mt-1 w-48 rounded-md shadow-lg bg-[#1A1C26] ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="py-0">
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    onClick={()=> kickChannelMember(memberId)}
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    onClick={() => muteChannelMember(memberId)}
                    className={classNames(
                      active
                        ? "rounded-md bg-slate-500 text-white"
                        : "text-gray-300",
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    onClick={() => addChannelAdmin(memberId)}
                    className={classNames(
                      active
                        ? "rounded-md bg-slate-500 text-white"
                        : "text-gray-300",
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    onClick={() => banChannelMember(memberId)}
                    className={classNames(
                      active
